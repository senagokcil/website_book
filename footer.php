                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <ul class="des">
                                        ...
                                        <li>
                                            ...
                                            <b><a href="#"><?php echo $ayarcek['telefon']; ?></a></b>
                                        </li>
                                        <li>
                                            <span style="color: white">E-MAİL :  </span>
                                            <b><a href="mailto://info@yourdomain.com"><?php echo $ayarcek['email']; ?></a></b>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="footer-block">
                                        <b><h3 class="footer-block-title">Bizi Takip Edin</h3></b>
