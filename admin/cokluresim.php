...
<input type="hidden" name="urun_id" value="<?php echo $_GET['id'] ?>">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title" style="color:black; font-family:'Lucida Sans Typewriter'; font-size:larger">ÇOKLU RESİM</h3>
              ...
              <!-- /.card-header -->
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    <?php 
                    $cokluresim = $baglanti->prepare("SELECT * FROM cokluresim where urun_id=:urun_id order by id ASC"); //cokluresim_id ye göre ilk kayıt olandan son kayıt olana doğru sıralıyorum.
                    $cokluresim->execute(array(
                        //her ürünün kendi çoklu resmini göstermeyi sağladık.
                        "urun_id"=>$_GET["id"]
                    ));
                   while ($cokluresimcek = $cokluresim->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    <tr>
                      ...
                      <form action="islem/islem.php" method="post">
                        ...
                        <td><button name="resimsil" type="submit" class="btn btn-danger">Sil</button></td>
                      </form>
                   <?php } ?>
                  </tbody>
                </table>
