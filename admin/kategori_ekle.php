      ...
      <div class="container-fluid">
        ...
        <div class="card card-primary col-md-12">
              <div class="card-header">
                <h3 class="card-title">KATEGORİ EKLE</h3></div>
                  <?php
            ...
            <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="kadi" class="form-control" placeholder="Kategori adı">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Kategori Sırası</label>
                    <input type="text" name="ksira" class="form-control" placeholder="Kategori sıra">
                  </div>
                  <div class="form-group">
